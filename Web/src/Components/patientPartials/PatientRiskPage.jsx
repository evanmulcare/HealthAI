...
const PatientRiskPage = ({ patient }) => {
  ...
  return (
    <div className="h-4/5 w-full overflow-scroll">
      ...
      <h1 className="text-2xl font-semibold text-gray-800 pl-10 mt-4">
        {t("riskPage.title")}
      </h1>
      ...
      <div>
        <h1 className="text-xl font-semibold text-gray-600 pl-10 mt-4">
          {t("riskPage.pastReports")} {patient?.firstName}
        </h1>
