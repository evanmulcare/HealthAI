...
export const downloadHeartDiseaseAccuracy = () => {
  downloadAccuracyReport(
    "https://healthaibackendtester.onrender.com/download-heart-data-accuracy-txt",
    "HeartDiseaseAccuracy.txt"
  );
};

export const downloadLungCancerAccuracy = () => {
  downloadAccuracyReport(
    "https://healthaibackendtester.onrender.com/download-lung-data-accuracy-txt",
    "LungCancerAccuracy.txt"
  );
};

export const downloadDiabetesAccuracy = () => {
  downloadAccuracyReport(
    "https://healthaibackendtester.onrender.com/download-diabetes-data-accuracy-txt",
    "DiabetesAccuracy.txt"
  );
};

export const downloadHeartDiseaseReport = () => {
  downloadDataset(
    "https://healthaibackendtester.onrender.com/download-heart-data-csv",
...
export const downloadLungCancerReport = () => {
  downloadDataset(
    "https://healthaibackendtester.onrender.com/download-lung-data-csv",
...
export const downloadDiabetesReport = () => {
  downloadDataset(
    "https://healthaibackendtester.onrender.com/download-diabetes-data-csv",
    "DiabetesDataset.csv"
  );
};
