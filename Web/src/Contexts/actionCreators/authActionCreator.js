...
export const signInWithEmailAndPasswordAsync =
  (email, password, userData) => (dispatch) => {
  ...
  async (dispatch) => {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        toast.success(
          "Registration successful. You can now login through the login area (If you are A doctor)",
          {
            position: "top-center",
            autoClose: 2000,
          }
        ...
        toast.error(
          "Error registering and logging in. Please check your information and try again.",
          {
            position: "top-center",
            autoClose: 2000,
          }
